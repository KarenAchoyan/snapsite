...
x.countdown(d,{elapse:o.elapse}).on('update.countdown',function(e){x.html(e.strftime(html_y+html_d+html_h+html_m+html_s))}).on('finish.countdown',function(e){x.html(e.strftime('<li><span>0</span></li><li><span>0</span></li><li><span>0</span></li><li><span>0</span></li>'));x.addClass('ended').append('<li class="expired">'+o.ex+'</li>')})})};Codevz_Plus.countdown()}(jQuery);
